...
project = u'IoT Assignment 2'
copyright = u'2020, Peter Moorhead, Tim Dalzotto, Taylor Cairns, Joel Tan'
author = u'Peter Moorhead, Tim Dalzotto, Taylor Cairns, Joel Tan'
...
htmlhelp_basename = 'IoTAssignment2doc'
...
latex_documents = [
    (master_doc, 'IoTAssignment2.tex', u'IoTAssignment2 Documentation',
     u'PTer', 'manual'),
]
...
man_pages = [
    (master_doc, 'iotassignment2', u'IoTAssignment2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IoTAssignment2', u'IoTAssignment2 Documentation',
     author, 'IoTAssignment2', 'One line description of project.',
     'Miscellaneous'),
]
